...
class Magecomp_Recaptcha_Model_Observer
{
    ...
    {
        try {
            if(Mage::app()->getRequest()->getRouteName()!="adminhtml" && Mage::app()->getRequest()->getRouteName()!='checkout')
            {

               if(Mage::helper('recaptcha/data')->showOnOnepage() || Mage::helper('recaptcha/data')->showOnRegister()){
